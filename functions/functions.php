...
function getPro(string $search){

global $db;

$get_products = "select * from products where product_title LIKE '%$search%' order by 1 DESC LIMIT 0,8";
...
<i class='fa fa-shopping-cart' data-price=$pro_price></i> Adicionar no Carrinho
