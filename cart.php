...
<p class="text-muted" > Você tem <?php echo $count; ?> item(s) no seu carriho. </p>
...
<th colspan="2"> <?php echo $total; ?>.00 Kz </th>
...
<i class="fa fa-chevron-left"></i> Continuar a Comprar
...
echo "<script>alert('O seu coupon expirou')</script>";
...
echo "<script>alert('O seu coupon foi aplicado')</script>";
...
<h3 class="text-center"> Você pode gostar também destes produtos </h3>
...
<p class="text-muted">
O envio e as taxas adicionais são calculadas com base nos valores que você inseriu.
</p>
