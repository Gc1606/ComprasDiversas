...
<i class="fa fa-dashboard" ></i> Dashboard / Adicionar loja
...
<i class="fa fa-money fa-fw"></i> Adicionar loja
...
<label class="col-md-3 control-label"> Nome da Loja : </label>
...
<label class="col-md-3 control-label"> Imagem da Loja : </label>
...
<label class="col-md-3 control-label"> Descrição da Loja: </label>
...
<label class="col-md-3 control-label"> Botão da Loja : </label>
...
<label class="col-md-3 control-label"> Link da loja : </label>
...
<input type="submit" name="submit" value="Adicionar Loja" class="btn btn-primary form-control">
...
echo "<script>alert('Você já inseriu 3 loja')</script>";
...
echo "<script>alert('Uma nova loja foi adicionada')</script>";
