...
<i class="fa fa-dashboard" ></i> Painel / Adicionar usuário
...
<i class="fa fa-money fa-fw" ></i> Adicionar usuário
...
<input type="submit" name="submit" value="Adicionar Usuário" class="btn btn-primary form-control">
