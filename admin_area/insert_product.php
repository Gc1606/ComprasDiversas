...
<i class="fa fa-dashboard"> </i> Painel / Inserir Produtos
...
<label class="col-md-3 control-label" > Link do Produto </label>
...
<label class="col-md-3 control-label" > Selecione Fabricante </label>
...
<label class="col-md-3 control-label" > Imagem 1 do Produto </label>
...
<label class="col-md-3 control-label" > Imagem 2 do Produto </label>
...
<label class="col-md-3 control-label" > Imagem 3 do Produto </label>
...
<label class="col-md-3 control-label" > Chave do Produto </label>
...
<label class="col-md-3 control-label" > Tabela de Produtos </label>
...
<a data-toggle="tab" href="#description"> Discrição do Produto </a>

</li>

<li>

<a data-toggle="tab" href="#features"> Quantidade </a>
