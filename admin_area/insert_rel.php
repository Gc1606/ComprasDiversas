...
<i class="fa fa-dashboard"></i> Dashboard / Inserir Relação
...
<i  class="fa fa-money fa-fw"></i> Inserir Relação
...
<label class="col-md-3 control-label"> T+itulo da relação </label>
...
<label class="col-md-3 control-label"> Selecionar Produto  </label>
...
<label class="col-md-3 control-label"> Selecionar Pacote  </label>

<div class="col-md-6">

<select name="bundle_id" class="form-control">

<option> Selecionar Pacote  </option>
...
<input type="submit" name="submit" class="btn btn-primary form-control" value="Inserir Relação">
