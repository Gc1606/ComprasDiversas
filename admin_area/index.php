...
$get_products = "SELECT * FROM products where product_title LIKE '%$search%'";
...
if(isset($_GET['insert_banner'])){

    include("index5.php");
    
    }
    
    if(isset($_GET['view_banner'])){
