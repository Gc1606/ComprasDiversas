...
<label class="col-md-3 control-label"> Título do Termo </label>
...
<label class="col-md-3 control-label"> Discrição do Termo </label>
...
<input type="submit" name="submit" value="Adicionar Termo" class="btn btn-primary form-control" >
...
echo "<script>alert('Novo termo foi inserido')</script>";
