...
<a href="my_account.php?my_orders"> <i class="fa fa-list"> </i> Meus pedidos </a>

</li>

<li class="<?php if(isset($_GET['pay_offline'])){ echo "active"; } ?>">

<a href="my_account.php?pay_offline"> <i class="fa fa-bolt"></i> Continuar a comprar </a>
...
<a href="my_account.php?change_pass"> <i class="fa fa-user"></i> Mudar senha </a>
...
<a href="my_account.php?delete_account"> <i class="fa fa-trash-o"></i> Eliminar conta </a>
