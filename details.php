...
<label class="col-md-5 control-label" >Quantidade de Produto </label>
...
<option>Selecionar Tamaho</option>
...
<label class="col-md-5 control-label" >Quantidade do pacote </label>
...
echo "<script>alert('Você deve fazer login para adicionar o produto na lista de desejos')</script>";
...
echo "<script>alert('Este produto já foi adicionado na lista de desejos')</script>";
...
<h3 class="text-center"> Produtos do pacote </h3>
